...
/*var touch=[9,8,4,5,"rahul","sharma"];
...
function setup() {
  ...
  restart = createSprite(width/2,height-140);
...
function draw() {
  ...
  background(160);
  fill("black");
  text("Score: "+ score, width-100,height-400);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(width,height-50,40,10);
